...
const PALETTE: &[(u8, u8, u8)] = &[
    ...
    (239, 68, 68), (20, 184, 166), (129, 140, 248), (251, 113, 133),
];
...
pub fn render_bubble_map(ctx: PlotRenderContext) {
    ...
    ctx.painter.rect_filled(ctx.plot_rect, 0.0, egui::Color32::from_rgb(13, 17, 23));
    ...
    let border_stroke = egui::Stroke::new(0.3, egui::Color32::from_rgba_premultiplied(42, 42, 74, 100));
...
fn parse_label_coords(label: &str) -> (f64, f64) {
    ...
    if centroid != (0.0, 0.0) { return centroid; }
