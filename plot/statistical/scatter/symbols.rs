...
use crate::plot::statistical::common::{
    escape_xml, hex6, palette_color, push_b, push_b as pb, push_f2, push_i,
};
...
pub fn render(cfg: &ScatterConfig) -> String {
    ...
    for i in 0..layout.n {
        ...
        if i < cfg.categories.len() {
            ...
            escape_xml(&mut f.buf, &cfg.categories[i]);
        }
        push_b(&mut f.buf, b"\">");
        draw_marker(
            &mut f.buf,
