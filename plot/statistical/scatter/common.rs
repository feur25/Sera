...
pub fn make_frame(cfg: &ScatterConfig, n: usize, legend_w: i32) -> Frame {
    Frame::new_html(cfg.title, cfg.width, cfg.height, 56, 38, 52, legend_w, n * 220 + 4096)
}

pub fn draw_marker(buf: &mut Vec<u8>, sym: &str, cx: i32, cy: i32, r: f64, fill_hex: &[u8; 6], stroke_hex: &[u8; 6], stroke_w: f64, fill_opacity: f64) {
    let rr = r.max(1.0);
    match sym {
        "square" => {
            let s = (rr * 1.7) as i32;
            let x = cx - s / 2; let y = cy - s / 2;
            push_b(buf, b"<rect x=\""); push_i(buf, x);
            push_b(buf, b"\" y=\""); push_i(buf, y);
            push_b(buf, b"\" width=\""); push_i(buf, s);
            push_b(buf, b"\" height=\""); push_i(buf, s);
            push_b(buf, b"\" fill=\"#"); buf.extend_from_slice(fill_hex);
            push_b(buf, b"\" fill-opacity=\""); push_f2(buf, fill_opacity);
            push_b(buf, b"\" stroke=\"#"); buf.extend_from_slice(stroke_hex);
        ...
        "diamond" => {
            ...
            push_i(buf, cx); buf.push(b','); push_i(buf, cy - s); buf.push(b' ');
            push_i(buf, cx + s); buf.push(b','); push_i(buf, cy); buf.push(b' ');
            push_i(buf, cx); buf.push(b','); push_i(buf, cy + s); buf.push(b' ');
            push_i(buf, cx - s); buf.push(b','); push_i(buf, cy);
            push_b(buf, b"\" fill=\"#"); buf.extend_from_slice(fill_hex);
            push_b(buf, b"\" fill-opacity=\""); push_f2(buf, fill_opacity);
            push_b(buf, b"\" stroke=\"#"); buf.extend_from_slice(stroke_hex);
            push_b(buf, b"\" stroke-width=\""); push_f2(buf, stroke_w);
        ...
        "triangle" | "triangle-up" => {
            ...
            push_b(buf, b"<polygon points=\"");
            push_i(buf, cx); buf.push(b','); push_i(buf, cy - s); buf.push(b' ');
            push_i(buf, cx + s); buf.push(b','); push_i(buf, cy + s); buf.push(b' ');
            push_i(buf, cx - s); buf.push(b','); push_i(buf, cy + s);
            push_b(buf, b"\" fill=\"#"); buf.extend_from_slice(fill_hex);
            push_b(buf, b"\" fill-opacity=\""); push_f2(buf, fill_opacity);
            push_b(buf, b"\" stroke=\"#"); buf.extend_from_slice(stroke_hex);
            push_b(buf, b"\" stroke-width=\""); push_f2(buf, stroke_w);
        ...
        "triangle-down" => {
            ...
            push_i(buf, cx - s); buf.push(b','); push_i(buf, cy - s); buf.push(b' ');
            push_i(buf, cx + s); buf.push(b','); push_i(buf, cy - s); buf.push(b' ');
            push_i(buf, cx); buf.push(b','); push_i(buf, cy + s);
            push_b(buf, b"\" fill=\"#"); buf.extend_from_slice(fill_hex);
            push_b(buf, b"\" fill-opacity=\""); push_f2(buf, fill_opacity);
            push_b(buf, b"\" stroke=\"#"); buf.extend_from_slice(stroke_hex);
            push_b(buf, b"\" stroke-width=\""); push_f2(buf, stroke_w);
        ...
        "cross" | "x" => {
            let s = (rr * 1.1) as i32;
            push_b(buf, b"<g stroke=\"#"); buf.extend_from_slice(stroke_hex);
            push_b(buf, b"\" stroke-width=\""); push_f2(buf, stroke_w.max(1.5));
            push_b(buf, b"\" stroke-linecap=\"round\"><line x1=\""); push_i(buf, cx - s);
            push_b(buf, b"\" y1=\""); push_i(buf, cy - s);
            push_b(buf, b"\" x2=\""); push_i(buf, cx + s);
            push_b(buf, b"\" y2=\""); push_i(buf, cy + s);
            push_b(buf, b"\"/><line x1=\""); push_i(buf, cx - s);
            push_b(buf, b"\" y1=\""); push_i(buf, cy + s);
            push_b(buf, b"\" x2=\""); push_i(buf, cx + s);
            push_b(buf, b"\" y2=\""); push_i(buf, cy - s);
            push_b(buf, b"\"/></g>");
        ...
        "plus" => {
            ...
            push_b(buf, b"\" stroke-width=\""); push_f2(buf, stroke_w.max(1.5));
            push_b(buf, b"\" stroke-linecap=\"round\"><line x1=\""); push_i(buf, cx - s);
            push_b(buf, b"\" y1=\""); push_i(buf, cy);
            push_b(buf, b"\" x2=\""); push_i(buf, cx + s);
            push_b(buf, b"\" y2=\""); push_i(buf, cy);
            push_b(buf, b"\"/><line x1=\""); push_i(buf, cx);
            push_b(buf, b"\" y1=\""); push_i(buf, cy - s);
            push_b(buf, b"\" x2=\""); push_i(buf, cx);
            push_b(buf, b"\" y2=\""); push_i(buf, cy + s);
            push_b(buf, b"\"/></g>");
        }
        "star" => {
            ...
            for k in 0..10 {
                ...
                if k > 0 { buf.push(b' '); }
                push_i(buf, px); buf.push(b','); push_i(buf, py);
            }
            push_b(buf, b"\" fill=\"#"); buf.extend_from_slice(fill_hex);
            push_b(buf, b"\" fill-opacity=\""); push_f2(buf, fill_opacity);
            push_b(buf, b"\" stroke=\"#"); buf.extend_from_slice(stroke_hex);
