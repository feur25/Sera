use super::common::{data_dot, finalize, open_frame, prepare, x_at};
use super::config::DumbbellConfig;
use crate::plot::statistical::common::{escape_xml, push_b, push_i, truncate};
...
pub fn render(cfg: &DumbbellConfig) -> String {
    ...
    for i in 0..n {
        ...
        push_b(
            &mut f.buf,
            b"\" stroke=\"#475569\" stroke-width=\"3.2\" stroke-linecap=\"round\"/>",
        );
