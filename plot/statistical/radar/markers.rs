use super::common::{prepare, open_svg, draw_grid, series_points, polygon_pts, dots_outlined, draw_legend, finalize};
...
pub fn render(cfg: &RadarConfig) -> String {
    ...
    for si in 0..p.n_ser {
        ...
        push_b(&mut b, b"\" stroke-width=\"1.6\" stroke-linejoin=\"round\" stroke-opacity=\"0.7\"/>");
        dots_outlined(&mut b, &pts, &hx, 5.5);
        push_b(&mut b, b"</g>");
    }
