...
impl PySGDRegressor {
    #[new]
    #[pyo3(signature = (alpha=0.0001, max_iter=1000, tol=1e-3, fit_intercept=true, eta0=0.01))]
    fn py_new(alpha: f64, max_iter: usize, tol: f64, fit_intercept: bool, eta0: f64) -> Self {
        Self { inner: crate::ml::linear::sgd::SGDRegressor::new(alpha, max_iter, tol, eta0, fit_intercept) }
    }
...
impl PyLinearSVC {
    ...
    fn py_new(c: f64, max_iter: usize, tol: f64) -> Self {
        Self { inner: crate::ml::svm::svm::LinearSVC::new(c, max_iter, tol) }
    }
...
impl PyLinearSVR {
    #[new]
    #[pyo3(signature = (c=1.0, epsilon=0.1, max_iter=1000, tol=1e-4))]
    fn py_new(c: f64, epsilon: f64, max_iter: usize, tol: f64) -> Self {
        Self { inner: crate::ml::svm::svm::LinearSVR::new(c, epsilon, max_iter, tol) }
    }
...
impl PyRobustScaler {
    #[new]
    #[pyo3(signature = (with_centering=true, with_scaling=true))]
    fn py_new(with_centering: bool, with_scaling: bool) -> Self {
        Self { inner: crate::ml::preprocessing::scalers::RobustScaler::new(with_centering, with_scaling) }
    }
...
impl PyPCA {
    ...
    fn py_new(n_components: usize) -> Self {
        Self { inner: crate::ml::decomposition::pca::PCA::new(n_components) }
    }
