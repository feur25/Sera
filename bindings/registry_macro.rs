...
macro_rules! for_each_json_chart_fn {
    ($mac:ident) => {
        ...
        $mac!(demo_bar,                  "demoBar");
        $mac!(demo_hbar,                 "demoHbar");
        $mac!(demo_line,                 "demoLine");
        $mac!(demo_multiline,            "demoMultiline");
        $mac!(demo_area,                 "demoArea");
        $mac!(demo_scatter,              "demoScatter");
        $mac!(demo_bubble,               "demoBubble");
        $mac!(demo_histogram,            "demoHistogram");
        $mac!(demo_grouped_bar,          "demoGroupedBar");
        $mac!(demo_stacked_bar,          "demoStackedBar");
        $mac!(demo_heatmap,              "demoHeatmap");
        $mac!(demo_pie,                  "demoPie");
        $mac!(demo_donut,                "demoDonut");
        $mac!(demo_boxplot,              "demoBoxplot");
        $mac!(demo_violin,               "demoViolin");
        $mac!(demo_slope,                "demoSlope");
        $mac!(demo_sunburst,             "demoSunburst");
        $mac!(demo_funnel,               "demoFunnel");
        $mac!(demo_treemap,              "demoTreemap");
        $mac!(demo_waterfall,            "demoWaterfall");
        $mac!(demo_bullet,               "demoBullet");
        $mac!(demo_radar,                "demoRadar");
        $mac!(demo_lollipop,             "demoLollipop");
        $mac!(demo_kde,                  "demoKde");
        $mac!(demo_ridgeline,            "demoRidgeline");
        $mac!(demo_candlestick,          "demoCandlestick");
        $mac!(demo_dumbbell,             "demoDumbbell");
        $mac!(demo_gauge,                "demoGauge");
        $mac!(demo_parallel,             "demoParallel");
        $mac!(demo_wordcloud,            "demoWordcloud");
        $mac!(demo_bubble_map,           "demoBubbleMap");
        $mac!(demo_choropleth,           "demoChoropleth");
        $mac!(demo_scatter3d,            "demoScatter3d");
        $mac!(demo_bar3d,                "demoBar3d");
        $mac!(demo_line3d,               "demoLine3d");
        $mac!(demo_radar3d,              "demoRadar3d");
        $mac!(demo_lollipop3d,           "demoLollipop3d");
        $mac!(demo_kde3d,                "demoKde3d");
        $mac!(demo_ridgeline3d,          "demoRidgeline3d");
        $mac!(demo_bubble3d,             "demoBubble3d");
        $mac!(demo_pie3d,                "demoPie3d");
        $mac!(demo_violin3d,             "demoViolin3d");
        $mac!(demo_heatmap3d,            "demoHeatmap3d");
        $mac!(demo_candlestick3d,        "demoCandlestick3d");
        $mac!(demo_dumbbell3d,           "demoDumbbell3d");
        $mac!(demo_funnel3d,             "demoFunnel3d");
        $mac!(demo_sunburst3d,           "demoSunburst3d");
        $mac!(demo_stacked_bar3d,        "demoStackedBar3d");
        $mac!(demo_globe3d,              "demoGlobe3d");
    };
}
