...
| `x_values`   | `list[float]` | required  | Event positions |
| `categories` | `list[str]`   | required  | Row assignment per event |
| `variant`    | `str`         | `"basic"` | Visual style (see table) |
| `palette`    | `list[int]`   | `None`    | Per-row color palette |
...
| `x_values`   | `list[float]` | requis    | Positions des événements |
| `categories` | `list[str]`   | requis    | Ligne d'appartenance par événement |
| `variant`    | `str`         | `"basic"` | Style visuel (voir tableau) |
| `palette`    | `list[int]`   | `None`    | Palette de couleurs par ligne |
