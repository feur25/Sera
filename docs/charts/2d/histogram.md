...
<style>#sp-tip{position:absolute;z-index:999999;pointer-events:none;opacity:0;transition:opacity .15s,transform .15s;transform:translateY(6px) scale(.97);background:#0b0e18;color:#f1f5f9;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;font-size:13px;border-radius:10px;min-width:160px;max-width:340px;box-shadow:0 4px 20px rgba(0,0,0,.45),0 0 0 1px rgba(255,255,255,.08);overflow:hidden}#sp-tip.sp-vis{opacity:1;transform:translateY(0) scale(1);pointer-events:auto}.sp-nav{display:flex;align-items:center;justify-content:space-between;padding:5px 10px;border-top:1px solid rgba(255,255,255,.08)}.sp-nav-btn{cursor:pointer;padding:0 10px;border-radius:5px;height:22px;line-height:22px;font-size:18px;background:rgba(255,255,255,.10);color:#e2e8f0;user-select:none;flex-shrink:0}.sp-nav-btn:hover{background:rgba(255,255,255,.22)}.sp-nav-dis{opacity:.25;pointer-events:none}.sp-nav-ctr{flex:1;text-align:center;font-size:11px;color:#94a3b8}.sp-head{padding:10px 14px 6px;font-weight:700;font-size:14px;color:#e2e8f0;border-bottom:1px solid rgba(255,255,255,.08)}.sp-body{padding:8px 14px 12px}.sp-row{display:flex;justify-content:space-between;align-items:baseline;gap:14px;padding:3px 0;border-bottom:1px solid rgba(255,255,255,.04)}.sp-row:last-child{border-bottom:none}.sp-key{color:#94a3b8;font-size:12px;white-space:nowrap}.sp-val{font-weight:600;font-size:12px;color:#f8fafc;text-align:right;word-break:break-all}#sp-tip img{display:block;width:100%;max-height:210px;object-fit:contain;border-top:1px solid rgba(255,255,255,.07)}#sp-tip video{display:block;width:100%;border-top:1px solid rgba(255,255,255,.07)}.sp-html{padding:8px 14px;font-size:12px;border-top:1px solid rgba(255,255,255,.07)}[data-idx]{cursor:pointer;transition:opacity .25s,filter .2s,transform .25s}[data-idx]:hover{filter:brightness(1.12) saturate(1.08)}.sp-cpanel{position:absolute;bottom:10px;left:50%;transform:translateX(-50%);background:#0b0e18;color:#f1f5f9;border-radius:10px;padding:8px 16px;font-size:12px;font-family:-apple-system,Arial,sans-serif;box-shadow:0 8px 24px rgba(0,0,0,.4);z-index:20;white-space:nowrap;display:none}.sp-cls-x{cursor:pointer;color:#94a3b8;margin-left:6px;font-size:13px}.sp-cls-x:hover{color:#f87171}</style><style>body{margin:0;background:transparent;padding:0}@keyframes sp-i{from{opacity:0;transform:translateY(8px) scale(.94)}}@keyframes sp-bar{from{opacity:0;transform:scaleY(0)}}@keyframes sp-pop{0%{opacity:0;transform:scale(0)}70%{transform:scale(1.08)}100%{opacity:1;transform:scale(1)}}@keyframes sp-arc{from{opacity:0;transform:scale(.82) rotate(-6deg)}}@keyframes sp-fn{from{opacity:0;transform:scaleX(.7) translateY(8px)}}svg rect[data-idx]{transform-box:fill-box;transform-origin:bottom center;animation:sp-bar .5s cubic-bezier(.22,.61,.36,1) both}svg circle[data-idx]{transform-box:fill-box;transform-origin:center;animation:sp-pop .42s cubic-bezier(.34,1.56,.64,1) both}svg path[data-idx]{transform-box:fill-box;transform-origin:center;animation:sp-arc .48s cubic-bezier(.22,.61,.36,1) both}svg polygon[data-idx]{transform-box:fill-box;transform-origin:center;animation:sp-fn .48s cubic-bezier(.22,.61,.36,1) both}svg line[data-idx]{animation:sp-i .45s cubic-bezier(.22,.61,.36,1) both}svg rect[data-idx]:hover{transform:scaleY(1.03);filter:brightness(1.12) saturate(1.1)}svg circle[data-idx]:hover{transform:scale(1.3);filter:brightness(1.15)}svg path[data-idx]:hover{filter:brightness(1.1) drop-shadow(0 2px 8px rgba(0,0,0,.2))}.sp-bg{fill:#fff}</style><style>.sp-bg{{fill:transparent!important}}.sp-ttl{{fill:#e2e8f0!important}}svg text{{fill:#cbd5e1!important}}.sp-ax-x,.sp-ax-y{{stroke:#475569!important}}.sp-gl{{stroke:#2d3748!important}}.sp-xl,.sp-yl{{fill:#94a3b8!important}}[id^='spp']{{box-shadow:none!important;border-radius:0!important}}</style><div id="spp1" style="position:relative;display:inline-block;border-radius:12px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,.07),0 0 0 1px rgba(0,0,0,.04)"><svg xmlns="http://www.w3.org/2000/svg" width="860" height="380" viewBox="0 0 860 380"><rect class="sp-bg" width="100%" height="100%"/><text x="446" y="26" text-anchor="middle" font-family="-apple-system,Arial,sans-serif" font-size="15" font-weight="700" fill="#1a202c" class="sp-ttl">Normal Distribution — N(0,1)</text><text x="48" y="337" text-anchor="end" font-family="Arial,sans-serif" font-size="9" fill="#9ca3af" class="sp-yt">0</text><line x1="52" y1="274" x2="840" y2="274" stroke="#e2e8f0" stroke-width="0.5" class="sp-gl"/><text x="48" y="277" text-anchor="end" font-family="Arial,sans-serif" font-size="9" fill="#9ca3af" class="sp-yt">66</text><line x1="52" y1="214" x2="840" y2="214" stroke="#e2e8f0" stroke-width="0.5" class="sp-gl"/><text x="48" y="217" text-anchor="end" font-family="Arial,sans-serif" font-size="9" fill="#9ca3af" class="sp-yt">132</text><line x1="52" y1="155" x2="840" y2="155" stroke="#e2e8f0" stroke-width="0.5" class="sp-gl"/><text x="48" y="158" text-anchor="end" font-family="Arial,sans-serif" font-size="9" fill="#9ca3af" class="sp-yt">198</text><line x1="52" y1="95" x2="840" y2="95" stroke="#e2e8f0" stroke-width="0.5" class="sp-gl"/><text x="48" y="98" text-anchor="end" font-family="Arial,sans-serif" font-size="9" fill="#9ca3af" class="sp-yt">264</text><line x1="52" y1="36" x2="840" y2="36" stroke="#e2e8f0" stroke-width="0.5" class="sp-gl"/><text x="48" y="39" text-anchor="end" font-family="Arial,sans-serif" font-size="9" fill="#9ca3af" class="sp-yt">330</text><line x1="52" y1="36" x2="52" y2="334" stroke="#cbd5e1" stroke-width="1" class="sp-ax-y"/><line x1="52" y1="334" x2="840" y2="334" stroke="#cbd5e1" stroke-width="1" class="sp-ax-x"/><text x="446" y="376" text-anchor="middle" font-family="Arial,sans-serif" font-size="10" fill="#6b7280" class="sp-xl">Value</text><text x="14" y="185" text-anchor="middle" font-family="Arial,sans-serif" font-size="10" fill="#6b7280" transform="rotate(-90,14,185)" class="sp-yl">Count</text><rect data-idx="0" data-series="0" data-lbl="-3.38–-3.22" data-kv-Count="5" data-kv-Min="-3.38" data-kv-Max="-3.22" x="52" y="330" width="18" height="4" fill="#6366f1" fill-opacity="0.80" rx="2" stroke="#fff" stroke-width="0.4"/><rect data-idx="1" data-series="0" data-lbl="-3.22–-3.06" data-kv-Count="0" data-kv-Min="-3.22" data-kv-Max="-3.06" x="71" y="334" width="18" height="0" fill="#6366f1" fill-opacity="0.80" rx="2" stroke="#fff" stroke-width="0.4"/><rect data-idx="2" data-series="0" data-lbl="-3.06–-2.90" data-kv-Count="5" data-kv-Min="-3.06" data-kv-Max="-2.90" x="91" y="330" width="18" height="4" fill="#6366f1" fill-opacity="0.80" rx="2" stroke="#fff" stroke-width="0.4"/><rect data-idx="3" data-series="0" data-lbl="-2.90–-2.75" data-kv-Count="5" data-kv-Min="-2.90" data-kv-Max="-2.75" x="111" y="330" width="18" height="4" fill="#6366f1" fill-opacity="0.80" rx="2" stroke="#fff" stroke-width="0.4"/><rect data-idx="4" data-series="0" data-lbl="-2.75–-2.59" data-kv-Count="5" data-kv-Min="-2.75" data-kv-Max="-2.59" x="130" y="330" width="18" height="4" fill="#6366f1" fill-opacity="0.80" rx="2" stroke="#fff" stroke-width="0.4"/><rect data-idx="5" data-series="0" data-lbl="-2.59–-2.43" data-kv-Count="15" data-kv-Min="-2.59" data-kv-Max="-2.43" x="150" y="321" width="18" height="13" fill="#6366f1" fill-opacity="0.80" rx="2" stroke="#fff" stroke-width="0.4"/><rect data-idx="6" data-series="0" data-lbl="-2.43–-2.27" data-kv-Count="20" data-kv-Min="-2.43" data-kv-Max="-2.27" x="170" y="316" width="18" height="18" fill="#6366f1" fill-opacity="0.80" rx="2" stroke="#fff" stroke-width="0.4"/><rect data-idx="7" data-series="0" data-lbl="-2.27–-2.11" data-kv-Count="20" data-kv-Min="-2.27" data-kv-Max="-2.11" x="189" y="316" width="18" height="18" fill="#6366f1" fill-opacity="0.80" rx="2" stroke="#fff" stroke-width="0.4"/><rect data-idx="8" data-series="0" data-lbl="-2.11–-1.96" data-kv-Count="40" data-kv-Min="-2.11" data-kv-Max="-1.96" x="209" y="298" width="18" height="36" fill="#6366f1" fill-opacity="0.80" rx="2" stroke="#fff" stroke-width="0.4"/><rect data-idx="9" data-series="0" data-lbl="-1.96–-1.80" data-kv-Count="45" data-kv-Min="-1.96" data-kv-Max="-1.80" x="229" y="294" width="18" height="40" fill="#6366f1" fill-opacity="0.80" rx="2" stroke="#fff" stroke-width="0.4"/><rect data-idx="10" data-series="0" data-lbl="-1.80–-1.64" data-kv-Count="95" data-kv-Min="-1.80" data-kv-Max="-1.64" x="249" y="249" width="18" height="85" fill="#6366f1" fill-opacity="0.80" rx="2" stroke="#fff" stroke-width="0.4"/><rect data-idx="11" data-series="0" data-lbl="-1.64–-1.48" data-kv-Count="85" data-kv-Min="-1.64" data-kv-Max="-1.48" x="268" y="258" width="18" height="76" fill="#6366f1" fill-opacity="0.80" rx="2" stroke="#fff" stroke-width="0.4"/><rect data-idx="12" data-series="0" data-lbl="-1.48–-1.32" data-kv-Count="90" data-kv-Min="-1.48" data-kv-Max="-1.32" x="288" y="253" width="18" height="81" fill="#6366f1" fill-opacity="0.80" rx="2" stroke="#fff" stroke-width="0.4"/><rect data-idx="13" data-series="0" data-lbl="-1.32–-1.16" data-kv-Count="90" data-kv-Min="-1.32" data-kv-Max="-1.16" x="308" y="253" width="18" height="81" fill="#6366f1" fill-opacity="0.80" rx="2" stroke="#fff" stroke-width="0.4"/><rect data-idx="14" data-series="0" data-lbl="-1.16–-1.01" data-kv-Count="235" data-kv-Min="-1.16" data-kv-Max="-1.01" x="327" y="122" width="18" height="212" fill="#6366f1" fill-opacity="0.80" rx="2" stroke="#fff" stroke-width="0.4"/><rect data-idx="15" data-series="0" data-lbl="-1.01–-0.85" data-kv-Count="240" data-kv-Min="-1.01" data-kv-Max="-0.85" x="347" y="118" width="18" height="216" fill="#6366f1" fill-opacity="0.80" rx="2" stroke="#fff" stroke-width="0.4"/><rect data-idx="16" data-series="0" data-lbl="-0.85–-0.69" data-kv-Count="255" data-kv-Min="-0.85" data-kv-Max="-0.69" x="367" y="104" width="18" height="230" fill="#6366f1" fill-opacity="0.80" rx="2" stroke="#fff" stroke-width="0.4"/><rect data-idx="17" data-series="0" data-lbl="-0.69–-0.53" data-kv-Count="280" data-kv-Min="-0.69" data-kv-Max="-0.53" x="386" y="82" width="18" height="252" fill="#6366f1" fill-opacity="0.80" rx="2" stroke="#fff" stroke-width="0.4"/><rect data-idx="18" data-series="0" data-lbl="-0.53–-0.37" data-kv-Count="290" data-kv-Min="-0.53" data-kv-Max="-0.37" x="406" y="73" width="18" height="261" fill="#6366f1" fill-opacity="0.80" rx="2" stroke="#fff" stroke-width="0.4"/><rect data-idx="19" data-series="0" data-lbl="-0.37–-0.22" data-kv-Count="310" data-kv-Min="-0.37" data-kv-Max="-0.22" x="426" y="55" width="18" height="279" fill="#6366f1" fill-opacity="0.80" rx="2" stroke="#fff" stroke-width="0.4"/><rect data-idx="20" data-series="0" data-lbl="-0.22–-0.06" data-kv-Count="305" data-kv-Min="-0.22" data-kv-Max="-0.06" x="446" y="59" width="18" height="275" fill="#6366f1" fill-opacity="0.80" rx="2" stroke="#fff" stroke-width="0.4"/><rect data-idx="21" data-series="0" data-lbl="-0.06–0.10" data-kv-Count="280" data-kv-Min="-0.06" data-kv-Max="0.10" x="465" y="82" width="18" height="252" fill="#6366f1" fill-opacity="0.80" rx="2" stroke="#fff" stroke-width="0.4"/><rect data-idx="22" data-series="0" data-lbl="0.10–0.26" data-kv-Count="330" data-kv-Min="0.10" data-kv-Max="0.26" x="485" y="36" width="18" height="298" fill="#6366f1" fill-opacity="0.80" rx="2" stroke="#fff" stroke-width="0.4"/><rect data-idx="23" data-series="0" data-lbl="0.26–0.42" data-kv-Count="310" data-kv-Min="0.26" data-kv-Max="0.42" x="505" y="55" width="18" height="279" fill="#6366f1" fill-opacity="0.80" rx="2" stroke="#fff" stroke-width="0.4"/><rect data-idx="24" data-series="0" data-lbl="0.42–0.58" data-kv-Count="240" data-kv-Min="0.42" data-kv-Max="0.58" x="524" y="118" width="18" height="216" fill="#6366f1" fill-opacity="0.80" rx="2" stroke="#fff" stroke-width="0.4"/><rect data-idx="25" data-series="0" data-lbl="0.58–0.73" data-kv-Count="210" data-kv-Min="0.58" data-kv-Max="0.73" x="544" y="145" width="18" height="189" fill="#6366f1" fill-opacity="0.80" rx="2" stroke="#fff" stroke-width="0.4"/><rect data-idx="26" data-series="0" data-lbl="0.73–0.89" data-kv-Count="245" data-kv-Min="0.73" data-kv-Max="0.89" x="564" y="113" width="18" height="221" fill="#6366f1" fill-opacity="0.80" rx="2" stroke="#fff" stroke-width="0.4"/><rect data-idx="27" data-series="0" data-lbl="0.89–1.05" data-kv-Count="175" data-kv-Min="0.89" data-kv-Max="1.05" x="583" y="176" width="18" height="158" fill="#6366f1" fill-opacity="0.80" rx="2" stroke="#fff" stroke-width="0.4"/><rect data-idx="28" data-series="0" data-lbl="1.05–1.21" data-kv-Count="165" data-kv-Min="1.05" data-kv-Max="1.21" x="603" y="185" width="18" height="149" fill="#6366f1" fill-opacity="0.80" rx="2" stroke="#fff" stroke-width="0.4"/><rect data-idx="29" data-series="0" data-lbl="1.21–1.37" data-kv-Count="160" data-kv-Min="1.21" data-kv-Max="1.37" x="623" y="190" width="18" height="144" fill="#6366f1" fill-opacity="0.80" rx="2" stroke="#fff" stroke-width="0.4"/><rect data-idx="30" data-series="0" data-lbl="1.37–1.52" data-kv-Count="90" data-kv-Min="1.37" data-kv-Max="1.52" x="643" y="253" width="18" height="81" fill="#6366f1" fill-opacity="0.80" rx="2" stroke="#fff" stroke-width="0.4"/><rect data-idx="31" data-series="0" data-lbl="1.52–1.68" data-kv-Count="130" data-kv-Min="1.52" data-kv-Max="1.68" x="662" y="217" width="18" height="117" fill="#6366f1" fill-opacity="0.80" rx="2" stroke="#fff" stroke-width="0.4"/><rect data-idx="32" data-series="0" data-lbl="1.68–1.84" data-kv-Count="70" data-kv-Min="1.68" data-kv-Max="1.84" x="682" y="271" width="18" height="63" fill="#6366f1" fill-opacity="0.80" rx="2" stroke="#fff" stroke-width="0.4"/><rect data-idx="33" data-series="0" data-lbl="1.84–2.00" data-kv-Count="60" data-kv-Min="1.84" data-kv-Max="2.00" x="702" y="280" width="18" height="54" fill="#6366f1" fill-opacity="0.80" rx="2" stroke="#fff" stroke-width="0.4"/><rect data-idx="34" data-series="0" data-lbl="2.00–2.16" data-kv-Count="30" data-kv-Min="2.00" data-kv-Max="2.16" x="721" y="307" width="18" height="27" fill="#6366f1" fill-opacity="0.80" rx="2" stroke="#fff" stroke-width="0.4"/><rect data-idx="35" data-series="0" data-lbl="2.16–2.32" data-kv-Count="25" data-kv-Min="2.16" data-kv-Max="2.32" x="741" y="312" width="18" height="22" fill="#6366f1" fill-opacity="0.80" rx="2" stroke="#fff" stroke-width="0.4"/><rect data-idx="36" data-series="0" data-lbl="2.32–2.47" data-kv-Count="20" data-kv-Min="2.32" data-kv-Max="2.47" x="761" y="316" width="18" height="18" fill="#6366f1" fill-opacity="0.80" rx="2" stroke="#fff" stroke-width="0.4"/><rect data-idx="37" data-series="0" data-lbl="2.47–2.63" data-kv-Count="15" data-kv-Min="2.47" data-kv-Max="2.63" x="780" y="321" width="18" height="13" fill="#6366f1" fill-opacity="0.80" rx="2" stroke="#fff" stroke-width="0.4"/><rect data-idx="38" data-series="0" data-lbl="2.63–2.79" data-kv-Count="5" data-kv-Min="2.63" data-kv-Max="2.79" x="800" y="330" width="18" height="4" fill="#6366f1" fill-opacity="0.80" rx="2" stroke="#fff" stroke-width="0.4"/><rect data-idx="39" data-series="0" data-lbl="2.79–2.95" data-kv-Count="5" data-kv-Min="2.79" data-kv-Max="2.95" x="820" y="330" width="18" height="4" fill="#6366f1" fill-opacity="0.80" rx="2" stroke="#fff" stroke-width="0.4"/><text x="52" y="348" text-anchor="middle" font-family="Arial,sans-serif" font-size="9" fill="#9ca3af" class="sp-xt">-3.38</text><text x="150" y="348" text-anchor="middle" font-family="Arial,sans-serif" font-size="9" fill="#9ca3af" class="sp-xt">-2.59</text><text x="249" y="348" text-anchor="middle" font-family="Arial,sans-serif" font-size="9" fill="#9ca3af" class="sp-xt">-1.80</text><text x="347" y="348" text-anchor="middle" font-family="Arial,sans-serif" font-size="9" fill="#9ca3af" class="sp-xt">-1.01</text><text x="446" y="348" text-anchor="middle" font-family="Arial,sans-serif" font-size="9" fill="#9ca3af" class="sp-xt">-0.22</text><text x="544" y="348" text-anchor="middle" font-family="Arial,sans-serif" font-size="9" fill="#9ca3af" class="sp-xt">0.58</text><text x="643" y="348" text-anchor="middle" font-family="Arial,sans-serif" font-size="9" fill="#9ca3af" class="sp-xt">1.37</text><text x="741" y="348" text-anchor="middle" font-family="Arial,sans-serif" font-size="9" fill="#9ca3af" class="sp-xt">2.16</text><text x="840" y="348" text-anchor="middle" font-family="Arial,sans-serif" font-size="9" fill="#9ca3af" class="sp-xt">2.95</text></svg><div class="sp-sel-ov" style="display:none"></div><div class="sp-cpanel"></div><script>(function(){
var wrap=document.getElementById('spp1');if(!wrap)return;wrap.removeAttribute('id');
var svg=wrap.querySelector('svg');var data=[{"title":"-3.38–-3.22","kv":[],"image":"https://raw.githubusercontent.com/feur25/seraplot/main/asset/logo.png"},{"title":"-3.22–-3.06","kv":[],"image":"https://raw.githubusercontent.com/feur25/seraplot/main/asset/logo.png"},{"title":"-3.06–-2.90","kv":[],"image":"https://raw.githubusercontent.com/feur25/seraplot/main/asset/logo.png"},{"title":"-2.90–-2.75","kv":[],"image":"https://raw.githubusercontent.com/feur25/seraplot/main/asset/logo.png"},{"title":"-2.75–-2.59","kv":[],"image":"https://raw.githubusercontent.com/feur25/seraplot/main/asset/logo.png"},{"title":"-2.59–-2.43","kv":[],"image":"https://raw.githubusercontent.com/feur25/seraplot/main/asset/logo.png"},{"title":"-2.43–-2.27","kv":[],"image":"https://raw.githubusercontent.com/feur25/seraplot/main/asset/logo.png"},{"title":"-2.27–-2.11","kv":[],"image":"https://raw.githubusercontent.com/feur25/seraplot/main/asset/logo.png"},{"title":"-2.11–-1.96","kv":[],"image":"https://raw.githubusercontent.com/feur25/seraplot/main/asset/logo.png"},{"title":"-1.96–-1.80","kv":[],"image":"https://raw.githubusercontent.com/feur25/seraplot/main/asset/logo.png"},{"title":"-1.80–-1.64","kv":[],"image":"https://raw.githubusercontent.com/feur25/seraplot/main/asset/logo.png"},{"title":"-1.64–-1.48","kv":[],"image":"https://raw.githubusercontent.com/feur25/seraplot/main/asset/logo.png"},{"title":"-1.48–-1.32","kv":[],"image":"https://raw.githubusercontent.com/feur25/seraplot/main/asset/logo.png"},{"title":"-1.32–-1.16","kv":[],"image":"https://raw.githubusercontent.com/feur25/seraplot/main/asset/logo.png"},{"title":"-1.16–-1.01","kv":[],"image":"https://raw.githubusercontent.com/feur25/seraplot/main/asset/logo.png"},{"title":"-1.01–-0.85","kv":[],"image":"https://raw.githubusercontent.com/feur25/seraplot/main/asset/logo.png"},{"title":"-0.85–-0.69","kv":[],"image":"https://raw.githubusercontent.com/feur25/seraplot/main/asset/logo.png"},{"title":"-0.69–-0.53","kv":[],"image":"https://raw.githubusercontent.com/feur25/seraplot/main/asset/logo.png"},{"title":"-0.53–-0.37","kv":[],"image":"https://raw.githubusercontent.com/feur25/seraplot/main/asset/logo.png"},{"title":"-0.37–-0.22","kv":[],"image":"https://raw.githubusercontent.com/feur25/seraplot/main/asset/logo.png"},{"title":"-0.22–-0.06","kv":[],"image":"https://raw.githubusercontent.com/feur25/seraplot/main/asset/logo.png"},{"title":"-0.06–0.10","kv":[],"image":"https://raw.githubusercontent.com/feur25/seraplot/main/asset/logo.png"},{"title":"0.10–0.26","kv":[],"image":"https://raw.githubusercontent.com/feur25/seraplot/main/asset/logo.png"},{"title":"0.26–0.42","kv":[],"image":"https://raw.githubusercontent.com/feur25/seraplot/main/asset/logo.png"},{"title":"0.42–0.58","kv":[],"image":"https://raw.githubusercontent.com/feur25/seraplot/main/asset/logo.png"},{"title":"0.58–0.73","kv":[],"image":"https://raw.githubusercontent.com/feur25/seraplot/main/asset/logo.png"},{"title":"0.73–0.89","kv":[],"image":"https://raw.githubusercontent.com/feur25/seraplot/main/asset/logo.png"},{"title":"0.89–1.05","kv":[],"image":"https://raw.githubusercontent.com/feur25/seraplot/main/asset/logo.png"},{"title":"1.05–1.21","kv":[],"image":"https://raw.githubusercontent.com/feur25/seraplot/main/asset/logo.png"},{"title":"1.21–1.37","kv":[],"image":"https://raw.githubusercontent.com/feur25/seraplot/main/asset/logo.png"},{"title":"1.37–1.52","kv":[],"image":"https://raw.githubusercontent.com/feur25/seraplot/main/asset/logo.png"},{"title":"1.52–1.68","kv":[],"image":"https://raw.githubusercontent.com/feur25/seraplot/main/asset/logo.png"},{"title":"1.68–1.84","kv":[],"image":"https://raw.githubusercontent.com/feur25/seraplot/main/asset/logo.png"},{"title":"1.84–2.00","kv":[],"image":"https://raw.githubusercontent.com/feur25/seraplot/main/asset/logo.png"},{"title":"2.00–2.16","kv":[],"image":"https://raw.githubusercontent.com/feur25/seraplot/main/asset/logo.png"},{"title":"2.16–2.32","kv":[],"image":"https://raw.githubusercontent.com/feur25/seraplot/main/asset/logo.png"},{"title":"2.32–2.47","kv":[],"image":"https://raw.githubusercontent.com/feur25/seraplot/main/asset/logo.png"},{"title":"2.47–2.63","kv":[],"image":"https://raw.githubusercontent.com/feur25/seraplot/main/asset/logo.png"},{"title":"2.63–2.79","kv":[],"image":"https://raw.githubusercontent.com/feur25/seraplot/main/asset/logo.png"},{"title":"2.79–2.95","kv":[],"image":"https://raw.githubusercontent.com/feur25/seraplot/main/asset/logo.png"}];
