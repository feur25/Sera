...
<div class="sp-donate-note">🔒 Secure — no PayPal account required to donate by card</div>
</div>
...
<div class="sp-donate-note">🔒 Sécurisé — pas besoin de compte PayPal pour donner par carte</div>
</div>
