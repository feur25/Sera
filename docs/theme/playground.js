(function () {
    ...
    function injectStyles() {
        ...
        var css = [
            ...
            '.sp-pg-title{font-size:10.5px;font-weight:700;letter-spacing:.22em;color:#cbd5e1;text-transform:uppercase;flex-shrink:0}',
            ...
            '.sp-pg-spacer{flex:1}',
            '.sp-pg-btn{background:#4f46e5;color:#fff;border:none;border-radius:4px;padding:5px 14px;font-size:12px;font-weight:600;cursor:pointer;transition:background .15s;font-family:inherit}',
            '.sp-pg-btn:hover{background:#6366f1}',
            '.sp-pg-btn:active{background:#3730a3}',
            '.sp-pg-btn[disabled]{opacity:.45;cursor:not-allowed}',
            '.sp-pg-conn{display:flex;align-items:center;gap:8px;font-size:11px;font-weight:600;color:#94a3b8;letter-spacing:.05em;text-transform:uppercase;flex-shrink:0;padding:4px 10px;background:#0a0f1c;border:1px solid #1e293b;border-radius:14px}',
            '.sp-pg-dot{width:8px;height:8px;border-radius:50%;background:#334155;flex-shrink:0;transition:background .3s}',
            '.sp-d-loading{background:#fbbf24!important;animation:sp-pulse 1s infinite}',
            '.sp-d-ready{background:#2dd4bf!important;animation:sp-ripple 2.4s infinite}',
            '.sp-d-err{background:#f87171!important;box-shadow:0 0 8px #f8717188}',
            '.sp-pg-tabs{display:flex;gap:0;padding:0;background:#0d1426;border-bottom:1px solid #1e293b;overflow-x:auto;scrollbar-width:none}',
            '.sp-pg-tabs::-webkit-scrollbar{display:none}',
            '.sp-pg-tab{font:600 11.5px/1 "Inter",sans-serif;letter-spacing:.04em;padding:9px 16px;color:#94a3b8;background:#141d33;border:none;border-right:1px solid #0d1426;border-bottom:1px solid #1e293b;cursor:pointer;transition:all .15s;white-space:nowrap;font-family:inherit;text-transform:capitalize}',
            '.sp-pg-tab:hover{color:#e0e7ff;background:#1a2540}',
            '.sp-pg-tab.sp-active{color:#f5f3ff;background:#0a0f1c;border-bottom-color:#0a0f1c}',
            ...
            '.sp-pg-ehdr{display:flex;align-items:center;padding:0;background:#0d1426;border-bottom:1px solid #1e293b;font:11px/1 "Segoe UI",sans-serif;color:#94a3b8}',
            ...
            '.sp-pg-divider{width:5px;background:#1e293b;cursor:col-resize;flex-shrink:0;position:relative;z-index:3;transition:background .15s}',
            '.sp-pg-divider:hover,.sp-pg-divider.sp-dragging{background:#6366f1}',
            '.sp-pg-pcol{flex:1;min-width:160px;display:flex;flex-direction:column;position:relative;background:#0a0f1c}',
            '.sp-pg-phdr{display:flex;align-items:center;padding:7px 14px;background:#0d1426;border-bottom:1px solid #1e293b;font:11px/1 "Segoe UI",sans-serif;color:#94a3b8;letter-spacing:.04em;text-transform:uppercase;font-weight:700;gap:8px}',
            '.sp-pg-phdr::before{content:"";display:inline-block;width:8px;height:8px;border-radius:50%;background:#2dd4bf;box-shadow:0 0 8px rgba(45,212,191,.6)}',
            '.sp-pg-iframe{flex:1;border:none;background:#fff;width:100%;display:block;animation:sp-fadein .28s cubic-bezier(.2,.8,.2,1)}',
            '.sp-pg-loader{position:absolute;left:0;right:0;top:33px;bottom:0;display:flex;align-items:center;justify-content:center;background:#0a0f1c;flex-direction:column;gap:18px;color:#94a3b8;font-size:12px;font-weight:600;letter-spacing:.1em;text-transform:uppercase;transition:opacity .25s;z-index:1;text-align:center;padding:0 24px}',
