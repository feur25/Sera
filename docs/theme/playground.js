(function () {
    ...
    function injectStyles() {
        ...
        var css = [
            ...
            '.sp-pg-wrap{position:relative;display:flex;flex-direction:column;overflow:hidden;margin:2.4em 0 2.6rem;font-family:"Inter","Segoe UI",sans-serif;background:var(--sp-surface);box-shadow:0 24px 70px -20px rgba(0,0,0,.5),0 0 0 1px var(--sp-border),inset 0 1px 0 rgba(255,255,255,.04)}',
            ...
            '.sp-pg-hdr{display:flex;align-items:center;gap:14px;padding:9px 14px;background:var(--sp-surface-2);border-bottom:1px solid var(--sp-border);flex-wrap:wrap;row-gap:8px}',
            '.sp-pg-title{font-size:10.5px;font-weight:700;letter-spacing:.22em;color:var(--sp-text);text-transform:uppercase;flex-shrink:0}',
            ...
            '.sp-pg-tabs{display:flex;gap:0;padding:0;background:var(--sp-surface-2);border-bottom:1px solid var(--sp-border);overflow-x:auto;scrollbar-width:none}',
            ...
            '.sp-pg-tab.sp-active{color:#e0e7ff;background:#0a0f1c;border-bottom-color:#0a0f1c}',
            ...
            '.sp-pg-phdr{display:flex;align-items:center;padding:7px 14px;background:var(--sp-surface-2);border-bottom:1px solid var(--sp-border);font:11px/1 "Segoe UI",sans-serif;color:var(--sp-text-muted);letter-spacing:.04em;text-transform:uppercase;font-weight:700;gap:8px}',
