(function () {
    ...
    function injectStyles() {
        ...
        var css = [
            ...
            '.sp-pg-wrap{position:relative;display:flex;flex-direction:column;overflow:hidden;margin:1.6em 0 2em;font-family:"Inter","Segoe UI",sans-serif;background:var(--sp-surface);box-shadow:inset 0 3px 10px rgba(0,0,0,.4),inset 0 -1px 0 rgba(255,255,255,.03),0 0 0 1px var(--sp-border)}',
