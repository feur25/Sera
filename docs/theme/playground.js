(function () {
    ...
    function injectStyles() {
        ...
        var css = [
            ...
            '.sp-pg-wrap{position:relative;display:flex;flex-direction:column;overflow:hidden;margin:0 0 2.6rem;font-family:"Inter","Segoe UI",sans-serif;background:#1e1e1e;box-shadow:0 24px 70px -20px rgba(0,0,0,.7),0 0 0 1px #2d2d30,inset 0 1px 0 rgba(255,255,255,.04)}',
