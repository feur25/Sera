...
#[crate::params(paramsList["title","x","y","z","labels","values","series","series_names","color_hex","palette","bg_color","variant","sort_order","color_groups","offset_groups","widths","super_categories","units_per_icon","max_icons_per_column","scene","orientation3d","width","height","x_label","y_label","z_label"])]
