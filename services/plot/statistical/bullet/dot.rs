use super::common::{finalize, label_left, max_for, open_svg, prepare, value_text};
...
pub fn render(cfg: &BulletConfig) -> String {
    ...
    for i in 0..p.n {
        ...
        if p.targets[i] > 0.0 {
            ...
            push_b(
                &mut b,
                b"\" stroke=\"#0f172a\" stroke-width=\"2.2\" stroke-dasharray=\"3 2\"/>",
            );
        }
