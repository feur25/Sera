...
#[crate::params(paramsList["title","labels","values","series","variant","series_names","notch","jitter","boxen_depth","x_label","y_label","z_label","bg_color","scene","orientation3d","theme","zone","max_points","width","height"])]
