...
#[crate::params(paramsList["title","labels","values","series","variant","notch","jitter","boxen_depth","x_label","y_label","z_label","bg_color","scene","orientation3d","theme","width","height"])]
