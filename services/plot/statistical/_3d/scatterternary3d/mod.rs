...
mod tests {
    ...
    fn every_scatterternary_variant_has_a_working_3d_counterpart() {
        twin::check_variants(build_scatterternary3d_chart, &demos(), ScatterTernaryVariant::all().len());
    }
    ...
    fn every_scene_applies_to_every_scatterternary_variant() {
        twin::check_scenes(build_scatterternary3d_chart, &demos());
    }
    ...
    #[test]
    fn every_scatterternary_variant_honours_an_explicit_zone() {
        twin::check_zone(build_scatterternary3d_chart, &demos());
    }
