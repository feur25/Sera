...
#[crate::chart_demo(
    "values=[4.74,5.51,4.77,4.68,4.07,4.79,6.11,5.42,6.04,5.25,5.39,5.19,3.33,5.86,5.51,5.5,3.31,3.26,4.11,4.53,5.31,4.95,5.52,4.36,5.31,5.39,4.34,6.72,5.56,6.2,4.38,4.26,4.66,4.89,5.63,5.25,4.55,4.04,4.48,6.22,4.19,5.24,5.43,3.51,5.05,6.31,2.99,4.68,4.89,4.18], categories=[\"Large group\",\"Large group\",\"Large group\",\"Large group\",\"Large group\",\"Large group\",\"Large group\",\"Large group\",\"Large group\",\"Large group\",\"Large group\",\"Large group\",\"Large group\",\"Large group\",\"Large group\",\"Large group\",\"Large group\",\"Large group\",\"Large group\",\"Large group\",\"Large group\",\"Large group\",\"Large group\",\"Large group\",\"Large group\",\"Large group\",\"Large group\",\"Large group\",\"Large group\",\"Large group\",\"Large group\",\"Large group\",\"Large group\",\"Large group\",\"Large group\",\"Large group\",\"Large group\",\"Large group\",\"Large group\",\"Large group\",\"Small group\",\"Small group\",\"Small group\",\"Small group\",\"Small group\",\"Small group\",\"Small group\",\"Small group\",\"Small group\",\"Small group\"], variant=\"stack\""
)]
...
pub fn render(cfg: &KdeConfig) -> String {
    ...
    let y_max = cum
        .last()
        .map(|c| c.iter().copied().fold(0.0_f64, f64::max))
        .unwrap_or(1.0)
        .max(1e-12);
    ...
    let py = |v: f64| f.pt as f64 + f.ph as f64 - v / y_max * f.ph as f64;
