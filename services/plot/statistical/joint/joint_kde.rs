use super::common::{data_bounds, draw_main_axes, finalize, kde_heat_grid, layout, open, right_kde, top_kde};
...
pub fn render(cfg: &JointConfig) -> String {
    ...
    kde_heat_grid(&mut f, &l, &bounds, cfg.x_values, cfg.y_values, cfg.colorscale, 34);
