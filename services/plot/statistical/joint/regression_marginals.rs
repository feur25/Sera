use super::common::{data_bounds, draw_main_axes, finalize, layout, open, px, py, right_histogram, top_histogram};
...
pub fn render(cfg: &JointConfig) -> String {
    ...
    for i in 0..n {
        ...
        push_b(&mut f.buf, b"\" fill-opacity=\"0.75\" stroke=\"#ffffff\" stroke-width=\"0.6\"/>");
    }
