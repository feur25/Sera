...
impl Lasso {
    pub fn new(alpha: f64, max_iter: usize, tol: f64, fit_intercept: bool) -> Self {
        Self {
            inner: ElasticNet::new(alpha, 1.0, max_iter, tol, fit_intercept),
        }
    }

    pub fn fit(&mut self, x: &[f64], n: usize, p: usize, y: &[f64]) {
        self.inner.fit(x, n, p, y);
    }
    pub fn fit_resumable(
        ...
        self.inner.fit_resumable(x, n, p, y, checkpoint_id);
    }
    pub fn predict(&self, x: &[f64], n: usize, p: usize) -> Vec<f64> {
        self.inner.predict(x, n, p)
    }
    ...
    pub fn set_tol(&mut self, v: f64) {
        self.inner.tol = v;
    }
    pub fn fit_intercept(&self) -> bool {
        self.inner.fit_intercept
    }
