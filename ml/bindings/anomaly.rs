...
#[crate::sera_doc(
    ...
    en = "IsolationForest — anomaly detection via random partitioning trees.",
    fr = "IsolationForest — détection d'anomalies via arbres de partition aléatoire.",
...
pub fn ml_isolation_forest(input: &str) -> String {
    ...
    let mut model = crate::ml::anomaly::isolation_forest::IsolationForest::new(
        n_estimators,
        max_samples,
        contamination,
        seed,
