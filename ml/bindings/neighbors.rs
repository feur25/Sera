...
#[crate::sera_doc(category = "Neighbors", en = "K-Nearest Neighbors classifier — majority vote among k nearest neighbors.", fr = "K plus proches voisins classifieur — vote majoritaire parmi les k voisins les plus proches.", file = "knn.md")]
