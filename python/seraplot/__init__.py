...
@lru_cache(maxsize=None)
def _region_labels_json_cached(map, group):
    return _region_labels_json(map, group)
...
def region_labels(map=None, group=None):
    return _json.loads(_region_labels_json_cached(map, group))
